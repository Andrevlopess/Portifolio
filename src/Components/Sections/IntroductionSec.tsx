...
const IntroductionSec = () => {
  ...
  return (
    <Flex w='80%' justifyContent='center' p='20px' minH='80vh' alignItems='center' flexWrap='wrap-reverse'>
      <motion.div
      ...
      >
        ...
        <Flex borderRadius='10px' transform='rotateZ(10deg)'
          ...
          <Image src={eu} maxH='min(350px, 90vw)' zIndex='banner' borderRadius='10px'
